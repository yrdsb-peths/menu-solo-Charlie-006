...
public class Button extends Actor {
    ...
    public Button(Runnable action, String labelText) {
        ...
        combinedImage.setFont(new Font("Arial", true, false, 20)); // Adjust the font size

        // Draw the label text on top of the button image (centered)
        combinedImage.drawString(labelText, (buttonImage.getWidth() - combinedImage.getFont().getSize() * labelText.length()) / 2, buttonImage.getHeight() / 2 + 5);
